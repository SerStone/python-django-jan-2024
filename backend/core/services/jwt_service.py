...
from core.enums.forget_pass_token import ForgetPassTokenEnum
...
class ForgetToken(BlacklistMixin, Token):
    pass


class ActivateFToken(ForgetToken):
    token_type = ForgetPassTokenEnum.ACTIVATE.token_type
